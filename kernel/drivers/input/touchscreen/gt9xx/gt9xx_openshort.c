...
#define MAX_LIMIT_VALUE_GROUP1 2004 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP1 792		// screen min limit
#define MAX_LIMIT_KEY_GROUP1 2398		// key_val max limit
#define MIN_LIMIT_KEY_GROUP1 1292		// key_val min limit
#define UNIFORMITY_GROUP1 60 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP1 {\
0x00,0x1C,0x02,0xC0,0x03,0x05,0x05,0x41,0x01,0x08,\
0x28,0x0F,0x55,0x3C,0x03,0x05,0x00,0x00,0x1F,0x7F,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x8A,0x09,0x0A,\
0x34,0x00,0x0C,0x08,0x03,0x06,0x00,0x02,0x33,0x1D,\
0x3C,0x01,0x00,0x00,0x00,0x03,0x64,0x32,0x00,0x00,\
0x2B,0x19,0x4B,0x94,0x45,0x02,0x00,0x00,0x00,0x04,\
0xE1,0x1C,0x00,0xBB,0x22,0x00,0x97,0x2B,0x00,0x7C,\
0x36,0x00,0x67,0x43,0x00,0x67,0x30,0x00,0x00,0x00,\
0x57,0x60,0x50,0xF0,0x00,0x27,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0F,\
0x0F,0x03,0x06,0x10,0x42,0xF8,0x0F,0x19,0x00,0x00,\
0x46,0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,0x0E,0x10,\
0x12,0x14,0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x20,0x22,0x21,0x1F,0x18,0x1E,0x1C,0x1D,\
0x16,0x10,0x12,0x0F,0x0C,0x0A,0x08,0x06,0x04,0x02,\
0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,\
0x00,0xFA,0x11,0xF1,0xFF,0xFF,0xFF,0xFF,0xFF,0xAF,\
0xFF,0xFF,0xFF,0xFF,0xE6,0x01}


//TODO: define your config for Sensor_ID == 1 here, if needed

#define MAX_LIMIT_VALUE_GROUP2 1784 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP2 618		// screen min limit
#define MAX_LIMIT_KEY_GROUP2 2499		// key_val max limit
#define MIN_LIMIT_KEY_GROUP2 1299		// key_val min limit
#define UNIFORMITY_GROUP2 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP2 {\
0x00,0x1C,0x02,0xC0,0x03,0x05,0x05,0x01,0x01,0x08,\
0x28,0x05,0x50,0x32,0x03,0x05,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x89,0x28,0x0B,\
0x19,0x16,0x12,0x0C,0x00,0x00,0x01,0x9B,0x04,0x25,\
0x00,0x00,0x00,0x00,0x00,0x03,0x64,0x32,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x00,0x00,0x00,\
0xF0,0x4A,0x3A,0x88,0x88,0x27,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
...
0x10,0x0F,0x0A,0x00,0x02,0x04,0x06,0x08,0x12,0xFF,\
0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,\
0x00,0x55,0x45,0x34,0x11,0xFF,0xFF,0xFF,0xFF,0xFF,\
...
#define MAX_LIMIT_VALUE_GROUP6 1508 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP6 490		// screen min limit
#define MAX_LIMIT_KEY_GROUP6 2030		// key_val max limit
#define MIN_LIMIT_KEY_GROUP6 1092		// key_val min limit
#define UNIFORMITY_GROUP6 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP6 {\
0x00,0x1C,0x02,0xC0,0x03,0x05,0x35,0x01,0x02,0x0F,\
...
0x00,0x2C,0x6E,0x94,0x55,0x02,0x05,0x00,0x00,0x04,\
0x8F,0x30,0x00,0x7A,0x3A,0x00,0x6A,0x45,0x00,0x5C,\
0x53,0x00,0x52,0x64,0x00,0x52,0x30,0x00,0x00,0x00,\
0xF0,0x40,0x30,0xFF,0xFF,0x27,0x60,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,0x0E,0x10,\
0x12,0x14,0x16,0xFF,0xFF,0xFF,0x00,0x00,0x00,0x00,\
...
0xFF,0xFF,0xFF,0xFF,0x2f,0x01}
    

u16 max_limit_value = 1730;     // screen max limit
u16 min_limit_value = 490;     // screen min limit
u16 max_limit_key = 770;       // key_val max limit
u16 min_limit_key = 300;        // key_val min limit
...
extern s32 gtp_send_cfg_rawdata(struct i2c_client *client);
